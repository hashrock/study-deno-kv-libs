...
export function createValue(
  partialValue: Partial<$.com.deno.kv.datapath.ReadRange>,
): $.com.deno.kv.datapath.ReadRange {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.com.deno.kv.datapath.ReadRange): unknown {
  ...
  if (value.start !== undefined) {
    result.start = tsValueToJsonValueFns.bytes(value.start);
  }
  if (value.end !== undefined) {
    result.end = tsValueToJsonValueFns.bytes(value.end);
  }
  if (value.limit !== undefined) {
    result.limit = tsValueToJsonValueFns.int32(value.limit);
  }
  if (value.reverse !== undefined) {
    result.reverse = tsValueToJsonValueFns.bool(value.reverse);
  }
  return result;
}
...
export function encodeBinary(
  value: $.com.deno.kv.datapath.ReadRange,
): Uint8Array {
