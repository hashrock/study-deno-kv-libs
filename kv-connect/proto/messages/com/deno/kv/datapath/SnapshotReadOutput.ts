...
export function createValue(
  partialValue: Partial<$.com.deno.kv.datapath.SnapshotReadOutput>,
...
export function encodeJson(
  value: $.com.deno.kv.datapath.SnapshotReadOutput,
): unknown {
  const result: any = {};
  ...
  if (value.readIsStronglyConsistent !== undefined) {
    result.readIsStronglyConsistent = tsValueToJsonValueFns.bool(
      value.readIsStronglyConsistent,
    );
  }
  return result;
}
...
export function decodeJson(
  ...
  if (value.readIsStronglyConsistent !== undefined) {
    result.readIsStronglyConsistent = jsonValueToTsValueFns.bool(
      value.readIsStronglyConsistent,
    );
  }
  return result;
