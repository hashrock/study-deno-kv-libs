...
import { name2num, num2name, Type as MutationType } from "./MutationType.ts";
import {
...
export function createValue(
  partialValue: Partial<$.com.deno.kv.datapath.Mutation>,
): $.com.deno.kv.datapath.Mutation {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.com.deno.kv.datapath.Mutation): unknown {
  ...
  if (value.mutationType !== undefined) {
    result.mutationType = tsValueToJsonValueFns.enum(value.mutationType);
  }
  if (value.expireAtMs !== undefined) {
    result.expireAtMs = tsValueToJsonValueFns.int64(value.expireAtMs);
  }
  return result;
}
...
export function decodeJson(value: any): $.com.deno.kv.datapath.Mutation {
  ...
  if (value.mutationType !== undefined) {
    result.mutationType = jsonValueToTsValueFns.enum(
      value.mutationType,
    ) as MutationType;
  }
  if (value.expireAtMs !== undefined) {
...
export function encodeBinary(
  value: $.com.deno.kv.datapath.Mutation,
): Uint8Array {
