...
export function createValue(
  partialValue: Partial<$.com.deno.kv.datapath.AtomicWrite>,
): $.com.deno.kv.datapath.AtomicWrite {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function decodeJson(value: any): $.com.deno.kv.datapath.AtomicWrite {
  ...
  result.mutations =
    value.mutations?.map((value: any) => decodeJson_2(value)) ?? [];
...
export function encodeBinary(
  value: $.com.deno.kv.datapath.AtomicWrite,
): Uint8Array {
